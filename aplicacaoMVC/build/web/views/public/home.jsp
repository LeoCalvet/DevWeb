...
<html lang="pt-br">
    ...
    <div class="container mt-5 text-center">
        <a href="/aplicacaoMVC/ProfessorController?acao=login" class="btn btn-outline-secondary">Login - Professor</a>
    </div>
    <div class="container mt-5 text-center">
        <a href="/aplicacaoMVC/AutenticaController?acao=login" class="btn btn-primary btn-lg">Acessar Área do Aluno</a>
    </div>
</head>
<body>
    <div class="container">
