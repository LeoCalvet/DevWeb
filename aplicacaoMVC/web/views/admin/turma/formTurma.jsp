...
<html lang="pt-br">
    ...
    <body>
        <div class="container mt-5">
            <h2 class="mb-4">Cadastro de Turma</h2>
            <form action="<%= request.getContextPath()%>/admin/turma" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="codigo_turma" name="codigo_turma" value="<%= turma != null ? turma.getCodigoTurma() : ""%>" required>
                </div>

                <!-- Nota -->
                <div class="mb-3">
                    <label for="nota" class="form-label">Nota</label>
                    <input type="number" step="0.1" class="form-control" id="nota" name="nota" value="<%= turma != null ? turma.getNota() : ""%>" required>
                </div>
